        ...
        <Row>
          <div className="col-md-12 midsection">
            ...
            <Row>
              <Project
                name="burger"
                imgPath={require("../components/assets/images/portofolio/first_impress.png")}
                linkDeployed="https://secret-garden-47035.herokuapp.com/"
                linkGithub="https://github.com/pfotis/Day-Planner"
              />
              <Project
                name="readMe-Generator"
                imgPath={require("../components/assets/images/portofolio/readme1.png")}
              ...
              <Project
                name="Portofolio"
                imgPath={require("../components/assets/images/portofolio/aboutMe.png")}
            ...
            <Row>
              <Project
                ...
                imgPath={require("../components/assets/images/portofolio/employeeList.png")}
              ...
              <Project
                name="note-taker"
                imgPath={require("../components/assets/images/portofolio/index.png")}
                linkDeployed="https://arcane-hamlet-40149.herokuapp.com/"
                linkGithub="https://github.com/pfotis/note-taker"
              />
              <Project
                name="team-profile-generator"
                imgPath={require("../components/assets/images/portofolio/teamPhoto.png")}
